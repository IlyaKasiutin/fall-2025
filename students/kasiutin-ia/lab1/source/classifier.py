...
class LinearClassifier:
    ...
    def _init_weights(self, n_features: int, weights_init_method: str, X: np.ndarray = None, y: np.ndarray = None):
    ...
    def fit(
        ...
        self._init_weights(X_train.shape[-1], weights_init_method, X_train, y_train)
